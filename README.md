...
[![CRAN downloads](https://cranlogs.r-pkg.org/badges/grand-total/MetaRVM)](https://CRAN.R-project.org/package=MetaRVM)
<!-- badges: end -->
...
- **Running Simulation**  
  Full example using a complete set of input files, showing how MetaRVM reads population mappings, mixing matrices, and vaccination schedules.
