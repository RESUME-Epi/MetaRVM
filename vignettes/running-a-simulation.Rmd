...
All MetaRVM simulations run in stochastic mode. Use `nrep` to control the number of stochastic replicates per parameter set.

An example YAML file is included in the package, `example_config_stochastic.yaml`. Here is its content:
